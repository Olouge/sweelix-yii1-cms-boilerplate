 ...
 * @category  views
 * @package   application.views.listTemplate
 */

$this->pageTitle = "Sweelix boiler plate - listTemplate";
use sweelix\yii1\web\helpers\Html;
?>

<div class="jumbotron">
	<h1>Sweelix Boilerplate - listTemplate</h1>
	<p>
	...
	<p>
		...
		?>
		<?php echo Html::link('url manuelle', [$this->node->getRoute(), 'tagId' => 50]); ?>
	</p>
